...
def laserscan_to_array(
    scan: LaserScan,
    remove_invalid_ranges: bool = False,
    include_ranges_and_intensities: bool = False,
    ...
    :param scan: Input laser scan message to get numpyed
    :param remove_invalid_ranges: whether to remove invalid ranges from the input scan,
        by default False
    :param include_ranges_and_intensities: whether to also return the ranges &
        intensities along with the cartesian position.

    :returns: numpy k-array where each element will be a structured record that
...
def array_to_laserscan(
    ...
    :param arr: Structured numpy array with fields x, y and z.
